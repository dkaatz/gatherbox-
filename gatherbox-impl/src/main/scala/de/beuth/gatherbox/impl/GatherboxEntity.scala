...
/**
  * This is an event sourced entity. It has a state, [[GatherboxState]], which
  ...
  */
class GatherboxEntity extends PersistentEntity {

  override type Command = GatherboxCommand[_]
  override type Event = GatherboxEvent
  override type State = GatherboxState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: GatherboxState = GatherboxState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case GatherboxState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        GatherboxState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class GatherboxState(message: String, timestamp: String)

object GatherboxState {
  /**
    ...
    */
  implicit val format: Format[GatherboxState] = Json.format
}

/**
  * This interface defines all the events that the GatherboxEntity supports.
  */
sealed trait GatherboxEvent

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends GatherboxEvent
...
/**
  ...
  */
sealed trait GatherboxCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends GatherboxCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends GatherboxCommand[String]
...
/**
  ...
  * application loader.
  */
object GatherboxSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[GatherboxState]
  )
}
